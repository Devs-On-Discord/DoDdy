...
//Source: https://gist.githubusercontent.com/Necroforger/8b0b70b1a69fa7828b8ad6387ebb3835/raw/17dd397eb5065c1d974c317645dff38e6929c134/embed.go
...
//SetTitle gives the embed a title
...
//SetURL sets the URL that the title points to
func (e *Embed) SetURL(URL string) *Embed {
	e.URL = URL
	return e
}

//SetColor sets the color of the bar on the left side of the embed
...
// TruncateDescription limits the size of the description to something discord will accept
...
// TruncateTitle limits the size of the title to something discord will accept
...
// TruncateFooter limits the size of the footer to something discord will accept
